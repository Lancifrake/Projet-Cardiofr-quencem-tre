...
bouton_1=Button(sous_boite,text="Moyenne_intervalle", font=("calibri",30),bg="pink",width=20,height=3)
bouton_1.grid(row=0,column=0,sticky=W)

    # Deuxieme
bouton_1=Button(sous_boite,text="Donnee_temps", font=("calibri",30),bg="pink",width=20,height=3)
