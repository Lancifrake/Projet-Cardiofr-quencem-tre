...
def changer1():
    interface.destroy()
    os.popen("python Interface\\poul_decroissant.py")

def changer2():
    interface.destroy()
    os.popen("python Interface\\temps_decroissant.py")
...
bouton_1=Button(sous_boite,text="Temps", font=("calibri",30),bg="pink",width=20,height=3,command=changer2)
