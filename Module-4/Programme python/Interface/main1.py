...
def changer2():
    interface.destroy()
    os.popen("python Interface\main5.py")
def changer_q():
    interface.destroy()
...
label_title=Label(boite_2,text="De quelle facon ?", font=("calibri",30),bg="pink")
...
bouton_1=Button(sous_boite,text="Par ordre", font=("calibri",30),bg="pink",width=20,height=3,command=changer1)
bouton_1.grid(row=0,column=0,sticky=W)

    # 
    # Deuxieme

bouton_2=Button(sous_boite,text="min/max", font=("calibri",30),bg="pink",width=20,height=3,command=changer2)
