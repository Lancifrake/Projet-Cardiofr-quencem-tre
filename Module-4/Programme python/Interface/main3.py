...
def changer1():
    interface.destroy()
    os.popen("python Interface\poul_croissant.py")

def changer2():
    interface.destroy()
    os.popen("python Interface\\temps_croissant.py")

def changer_q():
    interface.destroy()
    os.popen("python Interface\main2.py")
...
label_title=Label(boite_2,text="En fonction de quel parametre ?", font=("calibri",30),bg="pink")
...
bouton_1=Button(sous_boite,text="Pouls", font=("calibri",30),bg="pink",width=20,height=3,command=changer1)
bouton_1.grid(row=0,column=0,sticky=W)

    # Deuxieme

bouton_2=Button(sous_boite,text="Temps", font=("calibri",30),bg="pink",width=20,height=3,command=changer2)
